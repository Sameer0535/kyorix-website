    ...
    <div className="bg-[#0A0D14] border border-[#1E2638] rounded-xl shadow-2xl overflow-hidden">
      ...
      <div className="p-5 sm:p-6 lg:p-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 items-center">
          {/* Blue Corner (Chung) */}
          <div className="md:col-span-5 bg-gradient-to-b from-[#00308F]/25 to-[#0A0D14] border-2 border-kyorix-blue rounded-lg p-6 text-center relative overflow-hidden">
            <div className="text-[10px] font-mono tracking-widest text-blue-400 uppercase font-bold text-left">
              CHUNG (BLUE)
            </div>
            <div className="text-xl sm:text-2xl font-mono font-black tracking-wider text-white mt-2">
              INDIA
            </div>
            <div className="text-xs text-blue-300/80 font-mono mt-0.5">ATHLETE A</div>

            {/* Score Digit */}
            <div className="text-7xl sm:text-8xl lg:text-9xl font-black font-mono tracking-tight text-white my-3">
              08
            </div>

            {/* Penalties */}
            <div className="flex items-center justify-center gap-2 pt-3 border-t border-kyorix-blue/30 text-xs font-mono">
          ...
          <div className="md:col-span-2 flex flex-col items-center justify-center text-center py-2 space-y-4">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 rounded-full text-xs font-mono font-bold tracking-widest">
              <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
              LIVE
            </div>

            <div className="bg-[#111622] border border-[#1E2638] rounded-md px-4 py-2.5 w-full max-w-[170px]">
            ...
            <div className="bg-[#111622] border border-[#1E2638] rounded-md px-4 py-2.5 w-full max-w-[170px]">
              ...
              <div className="text-2xl sm:text-3xl font-black font-mono text-white tracking-wider mt-0.5">
                01:32
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-5 bg-gradient-to-b from-[#8B0000]/25 to-[#0A0D14] border-2 border-[#EF4444] rounded-lg p-6 text-center relative overflow-hidden">
            ...
            {/* Penalties */}
            <div className="flex items-center justify-center gap-2 pt-3 border-t border-[#EF4444]/30 text-xs font-mono">
              <span className="text-gray-400">GAM-JEOM:</span>
        ...
        <div className="mt-6 pt-4 border-t border-[#1E2638] grid grid-cols-2 sm:grid-cols-4 gap-3 text-[11px] font-mono">
